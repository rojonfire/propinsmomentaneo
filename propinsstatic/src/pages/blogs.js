  ...
  render() {
    ...
    return (
      <div className="bg-white">
              ...
              <Row>
                <Col sm="12" md="4" lg="2" className="mobilecenter">
                  <a
                    ...
                    rel="noopener noreferrer"
                  >
                    <button className="btn-home-referir">Contáctanos</button>
                  </a>
                </Col>
              </Row>
            </div>
              ...
              <Row className="center">
                <Col md="12" className="center text-center">
                  <div className=" center ganancia-por-referir">
                    <h5 className="">Ganancia por referir desde</h5>
                    <span>
                      <input
                        type="text"
            ...
            <Row justify="space-between">
              <Col md={{ span: 4 }}>
                <Card className={"TarjetaReferir"}>
                  ...
                  />
                  <div className="referirespaciomene">
                    <div className="pasosnuevo1">Creas Tu cuenta!</div>
                    <div className="pasosnuevo2">
                      Solo necesitas registrarte como Embajador y podrás empezar
              ...
              <Col md={{ span: 4 }}>
                <Card className={"TarjetaReferir"}>
                  ...
                  <div className="referirespaciomene">
                    <div className="pasosnuevo1">Agregar un referido</div>
                    <div className="pasosnuevo2">
                      En tu cuenta de Embajador tendrás a disposición la opción
                      de agregar un referido, solo debes ingresar sus datos.
                    </div>
                  </div>
                </Card>
              </Col>
              ...
              <Col md={{ span: 4 }}>
                <Card className={"TarjetaReferir"}>
                  ...
                  <div className="referirespaciomene">
                    <div className="pasosnuevo1">Nos contratan</div>
                    <div className="pasosnuevo2">
                      Nosotros nos encargamos de contactar al vendedor y cerrar
                      el trato con él.
                    </div>
                  </div>
                </Card>
              ...
              <Col md={{ span: 4 }}>
                <Card className={"TarjetaReferir"}>
                  ...
                  <div className="referirespaciomene">
                    <div className="pasosnuevo1">Vendemos</div>
                    <div className="pasosnuevo2">
                      Una vez firmada la promesa de compra venta, ¡te
                      depositamos tu dinero!
                    </div>{" "}
                  </div>
                </Card>
              ...
              <Col md={{ span: 4 }}>
                <Card className={"TarjetaReferir"}>
                  ...
                  <div className="referirespaciomene">
                    ...
                    <div className="pasosnuevo2">
                      En tu cuenta de Embajador tendrás a disposición la opción
                      de agregar un referido, solo debes ingresar sus datos o
                      comparte tu código Embajador (por Redes sociales) con
              ...
              <Col md={{ span: 4 }}>
                <Card className={"TarjetaReferir"}>
                  ...
                  <div className="referirespaciomene">
                    <div className="pasosnuevo1">Referimos</div>
                    <div className="pasosnuevo2">
                      Podrás seleccionar las propiedades que creas interesantes
                      para tu referido y ¡Listo!
                    </div>
                  </div>
                </Card>
              </Col>
        ...
        <div className="sectionmefui bg-white ">
